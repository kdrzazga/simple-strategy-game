...
public class BoardFieldTest {
    ...
    public void testGetXY() {
        BoardField a0a0 = new BoardField(board, "a0a0");
        BoardField a9g0 = new BoardField(board, "a9g0");
    ...
    public void testGetBoardXCoord() {
        BoardField b5c9 = new BoardField(board, "b5c9");
    ...
    public void testFindLowerBoardField2() {
        BoardField b2a9 = new BoardField(board, "b2a9");
    ...
    public void testFindLowerBoardFieldBeyondBoard() {
        BoardField e2q7 = new BoardField(board, "e2q7");
